...
BibOptions(check.entries = FALSE, bib.style = "authoryear", style = "markdown",
           dashed = TRUE)
bib <- ReadBib(here::here("04 SSF 2", "04_refs.bib"))
```
...
Recall that the $\beta$ for a habitat variable measures selection for that variable.

**What if the selection depends on another variable?**
...
Since the $\beta$s in our analyses measure selection, interactions allow us to selection as a *function* of another variable.
...
- Since our slope parameters measure selection, interactions allow us to model selection as a function of another variable.
...
.center[ ![Thurjfell et al. 2014 Fig 1](../03 SSF 1/img/ssf1.png) ]

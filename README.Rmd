...
---
  ...
  This course provides an introduction to advanced methods to analyze animal movement data using R. Participants will learn how to fit habitat-selection functions, step-selection functions and hidden Markov models.
...
## Day 4
8. State-switching SSFs (J)
9. Simulating from fitted SSFs (J)
10. Validation (B)
11. Q&A (both)

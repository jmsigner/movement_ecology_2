...
Let's apply what we've learned about RSFs. Refer to the lecture slides (<a href="02a_lecture.html" target="_blank" rel="noopener noreferrer">02a_lecture.html</a>) and the walkthrough code (`02b_walkthrough.R`) as a refresher.

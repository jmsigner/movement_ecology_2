...
Let's apply what we've learned about model validation. Refer to the lecture slides (<a href="08a_lecture.html" target="_blank" rel="noopener noreferrer">08a_lecture.html</a>) and the walkthrough code (`08b_walkthrough.R`) as a refresher.
